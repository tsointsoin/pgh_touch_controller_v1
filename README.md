...
So far, all the digitalWrite/digitalRead/pinMode have been replaced by their 'Fast' counterpart using the digitalWriteFast library. This was to try to get a more steady clock but unfortunately jittering is still present.
